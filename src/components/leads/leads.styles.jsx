...
export const LeadCardRole = styled.div`
  ${tw`text-brown-4 font-Poppins font-bold text-1.5sm 3md:text-xl flex justify-center opacity-80 mb-1`}
`

export const LeadCardOrganization = styled.div`
  ${tw`text-brown-4 font-Poppins font-bold text-1.5sm 3md:text-lg flex justify-center opacity-80 text-center xxsm:text-xs`}
`
