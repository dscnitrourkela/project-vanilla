...
export const EventWrapper = styled.div`
  ${tw`overflow-hidden md:h-[640px] w-full flex items-center justify-center`}
`
...
export const EventsTitleMobile = styled.h3`
  ${tw`text-[40px] xxsm:text-[50px] xsm:text-[65px] mb-1 md:text-[80px] 1.5lg:text-[100px] 2.3xl:text-[115px] 2.5xl:text-[128px] font-[700] text-brown-4 w-full ml-5`}
`
