...
const config = {
  ...
  ogLanguage: 'en_UK',
  googleAnalyticsID: 'G-RDKTC8V88M',
  ...
  // Social component
  twitterHandle: '@AicheNit',
  twitter: 'https://x.com/AicheNit',
  x: 'https://x.com/AicheNit',
  linkedin: 'https://www.linkedin.com/company/aiche-nitr',
  youtube: 'https://www.youtube.com/@aichenitr4693',
  facebook: 'https://www.facebook.com/AIChENITR',
  instagram: 'https://www.instagram.com/aiche.nitrkl',
  register: 'https://sthitivartana.in/register',
  join: 'https://sthitivartana.in'
}
