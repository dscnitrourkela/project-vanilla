export const events = [
  ...
  },
  {
    EventId: 4,
    img: 'https://res.cloudinary.com/dmvdbpyqk/image/upload/v1717655995/kspdwtblyqcwoqqqeddc.svg',
    EventTitle: 'Student Poster Competition',
  ...
  },
  {
    EventId: 5,
    img: 'https://res.cloudinary.com/dmvdbpyqk/image/upload/v1717655996/ndoqb3l9m6no38kehat8.svg',
    EventTitle: 'Student Technical Paper Competition',
  ...
  //   subtitle: '',
  //   details: [
  //     'It is basically a kind of MUN or student panel discussion where undergraduate students, professors and intellectuals from various regions come together to discuss and exchange thoughts about a specific topic.It will aid to broaden the minds in rational and logical way, promote the collaboration between education and industrial field.'
  //   ]
  // },
  // {
  //   id: 7,
  ...
  //   id: 8,
  //   img: 'https://res.cloudinary.com/dmvdbpyqk/image/upload/v1717655995/kspdwtblyqcwoqqqeddc.svg',
  //   title: 'Night of Networking',
  //   subtitle: 'Establishing connections: Night of networking',
  //   details: [
  //     'This is the opportunity to get to know your fellow AICHE members from different universities. Night of networking helps the participants to meet new people and get a taste of different ideas, culture and knowledge from industry experts.',
  //     'This will help you to establish a professional relationship that would be fruitful for your upcoming bright career and aid in unlocking new opportunities.',
  //     'Participants will get to know each other by indulging themselves in invigorating activities and turning this fun-filled night into a memorable one.'
  //   ]
  // }
]
